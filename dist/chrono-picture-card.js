  ...
  `;render(){if(!this._config)return html``;const t=this._config,e=serializeExtrasToYaml(t,UI_CARD_KEYS),i=t.image_source_type??"camera",o="fill"!==(t.fit_mode??"fill");return html`
      ...
      <ha-expansion-panel header="Image / Camera" outlined .expanded=${!0}>
        ...
        <div class="image-ratio">
          ${cpButtonPicker("Source type",i,this._imageSourceTypeOptions,t=>this._valueChanged("image_source_type",t))}
        </div>
        ...
        ${"entity"===i?html`
          <div class="image-ratio">
            ${cpTextField("Image entity\n<i>image. or person. entity</i>",t.image_entity??"",t=>this._valueChanged("image_entity",t))}
          </div>
        `:""}

        <!-- Fit mode + optional object position -->
        <div class="${o?"image-display":"image-source"}">
          ${cpSelectField("Fit mode",t.fit_mode??"fill",this._fitModeOptions,t=>this._valueChanged("fit_mode",t))}
          ${o?cpSelectField("Object position",t.object_position??"center",this._objectPositionOptions,t=>this._valueChanged("object_position",t)):""}
        </div>

        <!-- Aspect ratio -->
        <div class="image-ratio">
          ${cpTextField("Aspect ratio\n<i>e.g. 16x9 · 4x3 · 16x10 · leave empty for auto</i>",t.aspect_ratio??"",t=>this._valueChanged("aspect_ratio",t))}
        </div>

        <!-- Bar background color -->
        <div class="image-ratio">
          ${cpColorPicker("Bar background color\n<i>leave empty for default rgba(0,0,0,0.3)</i>",t.bar_background_color??"",t=>this._valueChanged("bar_background_color",t))}
        </div>
