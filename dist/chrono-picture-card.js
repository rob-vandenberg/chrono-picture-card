import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import{repeat}from"https://unpkg.com/lit@2.0.0/directives/repeat.js?module";import jsyaml from"https://cdn.jsdelivr.net/npm/js-yaml@4/+esm";const CARD_VERSION="1.0.301",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cPICTURE%c-CARD %c v1.0.301 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DEFAULT_ITEM={_id:"",show:!0,horizontal:"center",vertical:"bottom",icon:"",show_state:!1,font_color:"",font_size:1.2,font_weight:600,line_height:1.2,border_radius:50,background_color:"",padding_top:10,padding_bottom:10,padding_left:10,padding_right:10},DEFAULT_ENTITY_ITEM={...DEFAULT_ITEM,entity:""},DEFAULT_TEMPLATE_ITEM={...DEFAULT_ITEM,template:""},DEFAULT_CONFIG={image_source_type:"camera",entity:"",camera_image:"",camera_view:"live",image:"",image_entity:"",aspect_ratio:"",fit_mode:"fill",object_position:"center",bottom_bar_background_color:"#0000004D",top_bar_background_color:"",items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),UI_ITEM_KEYS=new Set(["_id","show","entity","template","horizontal","vertical","icon","show_state","font_color","font_size","font_weight","line_height","border_radius","background_color","padding_top","padding_bottom","padding_left","padding_right"]),UI_CARD_KEYS=new Set(["type","image_source_type","entity","camera_image","camera_view","image","image_entity","aspect_ratio","fit_mode","object_position","bottom_bar_background_color","top_bar_background_color","items"]),VERTICAL_OPTIONS=[{label:"Top",value:"top"},{label:"Bottom",value:"bottom"}],HORIZONTAL_OPTIONS=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"}],IMAGE_SOURCE_TYPE_OPTIONS=[{label:"Camera",value:"camera"},{label:"Image URL",value:"url"},{label:"Image entity",value:"entity"}],CAMERA_VIEW_OPTIONS=[{label:"Auto",value:"auto"},{label:"Live",value:"live"}],FIT_MODE_OPTIONS=[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"},{label:"Fill",value:"fill"}],OBJECT_POSITION_OPTIONS=[{label:"Center",value:"center"},{label:"Top",value:"top"},{label:"Bottom",value:"bottom"},{label:"Left",value:"left"},{label:"Right",value:"right"}],SHOW_ITEM_POSITION_BADGES=!1,VERTICAL_BADGE_COLORS={top:"#ac00ac",bottom:"#0600ff"},HORIZONTAL_BADGE_COLORS={left:"#bb9e00",center:"#10a800",right:"#00a896"},GROUP_DIVIDER_COLOR="#009ac7",_GROUP_DEFS=[{vertical:"top",horizontal:"left",label:"Top · Left"},{vertical:"top",horizontal:"center",label:"Top · Center"},{vertical:"top",horizontal:"right",label:"Top · Right"},{vertical:"bottom",horizontal:"left",label:"Bottom · Left"},{vertical:"bottom",horizontal:"center",label:"Bottom · Center"},{vertical:"bottom",horizontal:"right",label:"Bottom · Right"}],_GROUP_ORDER=_GROUP_DEFS.map(t=>`${t.vertical}-${t.horizontal}`);function sortItems(t){const e=t=>`${t.vertical??"bottom"}-${t.horizontal??"center"}`;return[...t].sort((t,i)=>_GROUP_ORDER.indexOf(e(t))-_GROUP_ORDER.indexOf(e(i)))}function generateId(t=[]){const e=new Set(t.map(t=>t._id));let i;do{i=Math.random().toString(16).slice(2,10)}while(e.has(i));return i}function migrateConfig(t){let e=!1;if(t.left_items||t.center_items||t.right_items){const i=sortItems([...(t.left_items??[]).map(t=>({...t,horizontal:"left"})),...(t.center_items??[]).map(t=>({...t,horizontal:"center"})),...(t.right_items??[]).map(t=>({...t,horizontal:"right"}))]),{left_items:o,center_items:a,right_items:r,...n}=t;t={...n,items:i},e=!0}if(t.items?.some(t=>!t._id)){const i=[];for(const e of t.items)i.push(e._id?e:{...e,_id:generateId(t.items.concat(i))});t={...t,items:i},e=!0}return{config:t,migrated:e}}function serializeExtrasToYaml(t,e){const i={};for(const[o,a]of Object.entries(t))e.has(o)||(i[o]=a);if(!Object.keys(i).length)return"";try{return jsyaml.dump(i,{indent:2}).trimEnd()}catch(t){return""}}function parseYamlExtras(t){const e=(t??"").trim();if(!e)return{};try{const t=jsyaml.load(e);return t&&"object"==typeof t&&!Array.isArray(t)?t:null}catch(t){return null}}function fireEvent(t,e,i={},o={}){const a=new Event(e,{bubbles:o.bubbles??!0,cancelable:Boolean(o.cancelable),composed:o.composed??!0});return a.detail=i,t.dispatchEvent(a),a}function navigate(t,e={}){e.replace?history.replaceState(null,"",t):history.pushState(null,"",t),fireEvent(window,"location-changed",{replace:e.replace??!1})}function toggleEntity(t,e){e&&t.callService("homeassistant","toggle",{entity_id:e})}function handleAction(t,e,i,o){let a;switch("double_tap"===o&&i.double_tap_action?a=i.double_tap_action:"hold"===o&&i.hold_action?a=i.hold_action:"tap"===o&&i.tap_action&&(a=i.tap_action),a||(a={action:"more-info"}),a.action){case"none":default:break;case"more-info":fireEvent(t,"hass-more-info",{entityId:a.entity??i.entity});break;case"navigate":a.navigation_path&&navigate(a.navigation_path,{replace:a.navigation_replace});break;case"url":a.url_path&&window.open(a.url_path,"_blank");break;case"toggle":toggleEntity(e,i.entity);break;case"perform-action":case"call-service":{const t=a.perform_action??a.service;if(!t)break;const[i,o]=t.split(".",2);if(!i||!o)break;e.callService(i,o,a.data??a.service_data,a.target);break}case"fire-dom-event":fireEvent(t,"ll-custom",a)}}function cpParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)||String(i)!==e?null:i}function cpTextField(t,e,i,o={}){return html`
  ...
  `;constructor(){super(),this.value="",this.options=[],this._open=!1,this._cursor=-1,this._onOutsideClick=this._onOutsideClick.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOutsideClick)}_onOutsideClick(t){this.shadowRoot.contains(t.composedPath()[0])||t.composedPath()[0]===this||(this._open=!1,this._cursor=-1)}_select(t){this.value=t,this._open=!1,this._cursor=-1,this.dispatchEvent(new CustomEvent("change",{detail:{value:t},bubbles:!0,composed:!0}))}_handleKeyDown(t){const e=this.options??[];this._open?"ArrowDown"===t.key?(this._cursor=Math.min(this._cursor+1,e.length-1),t.preventDefault()):"ArrowUp"===t.key?(this._cursor=Math.max(this._cursor-1,0),t.preventDefault()):"Enter"===t.key?(this._cursor>=0&&this._cursor<e.length&&this._select(e[this._cursor].value),t.preventDefault()):"Escape"===t.key&&(this._open=!1,this._cursor=-1,t.preventDefault()):"ArrowDown"!==t.key&&"ArrowUp"!==t.key||(this._open=!0,this._cursor=0,t.preventDefault())}render(){const t=this.options??[];return html`
      ...
      `:""}
    `}focus(){this.shadowRoot?.querySelector(".combobox-input")?.focus()}}customElements.define("chrono-cp-select",CpSelect);class ChronoPictureCardEditor extends LitElement{static properties={hass:{attribute:!1},_config:{state:!0},_expandedItemId:{state:!0},_removedItem:{state:!0}};setConfig(t){const{config:e,migrated:i}=migrateConfig(t);this._config=e,i&&this._fireConfig()}_fireConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_valueChanged(t,e){if(!this._config)return;this._clearUndo();const i=e.target.value??e.detail?.value;this._config={...this._config,[t]:i},this._fireConfig()}_cardYamlChanged(t){if(!this._config)return;const e=parseYamlExtras(t.target.value??t.detail?.value??"");if(null===e)return;const i={};for(const[t,e]of Object.entries(this._config))UI_CARD_KEYS.has(t)&&(i[t]=e);this._config={...i,...e},this._fireConfig()}_itemChanged(t,e,i){if(!this._config)return;this._clearUndo();const o=i.target.value??i.detail?.value;let a;if(NUMERIC_ITEM_KEYS.has(e)){const t=cpParseNumber(o);if(null===t)return;a=t}else a=o;let r=[...this._config.items??[]];r[t]={...r[t],[e]:a},"horizontal"!==e&&"vertical"!==e||(r=sortItems(r)),this._config={...this._config,items:r},this._fireConfig()}_itemYamlChanged(t,e){if(!this._config)return;this._clearUndo();const i=parseYamlExtras(e.target.value??e.detail?.value??"");if(null===i)return;const o=[...this._config.items??[]],a=o[t],r={};for(const[t,e]of Object.entries(a))UI_ITEM_KEYS.has(t)&&(r[t]=e);o[t]={...r,...i},this._config={...this._config,items:o},this._fireConfig()}_itemToggled(t,e,i){if(!this._config)return;this._clearUndo();const o=i.target.checked,a=[...this._config.items??[]];a[t]={...a[t],[e]:o},this._config={...this._config,items:a},this._fireConfig()}_addItem(t){const e=this._config.items??[];let i="";if("entity"===t){const t=this.hass?.states??{};i=Object.keys(t).find(t=>t.startsWith("light."))??Object.keys(t)[0]??""}else i="{{ now().strftime('%H:%M') }}";const o="entity"===t?{...DEFAULT_ENTITY_ITEM,_id:generateId(e),entity:i}:{...DEFAULT_TEMPLATE_ITEM,_id:generateId(e),template:i},a=sortItems([...e,o]);this._expandedItemId=o._id,this._removedItem=null,this._config={...this._config,items:a},this._fireConfig(),this.updateComplete.then(async()=>{const t=this.shadowRoot?.querySelector(`[data-item-id="${o._id}"]`);t&&(await t.updateComplete,t.scrollIntoView({behavior:"smooth",block:"nearest"}),t.querySelector("chrono-cp-textfield")?.focus())})}_removeItem(t){const e=[...this._config.items??[]];this._removedItem={item:e[t],index:t},this._config={...this._config,items:e.filter((e,i)=>i!==t)},this._fireConfig()}_undoRemove(){if(!this._removedItem)return;const{item:t,index:e}=this._removedItem,i=[...this._config.items??[]];i.splice(e,0,t),this._removedItem=null,this._config={...this._config,items:i},this._fireConfig()}_clearUndo(){this._removedItem&&(this._removedItem=null)}_buildRows(t){const e=[];let i=0;for(const o of _GROUP_DEFS)e.push({type:"divider",group:o,key:`divider-${o.vertical}-${o.horizontal}`}),t.forEach((t,a)=>{(t.vertical??"bottom")===o.vertical&&(t.horizontal??"center")===o.horizontal&&(this._removedItem&&i===this._removedItem.index&&e.push({type:"undo",key:"undo-remove"}),e.push({type:"item",item:t,itemIndex:a,key:t._id}),i++)});return this._removedItem&&i===this._removedItem.index&&e.push({type:"undo",key:"undo-remove"}),e}_itemMoved(t){t.stopPropagation(),this._clearUndo();const{oldIndex:e,newIndex:i}=t.detail,o=[...this._config.items??[]],a=this._buildRows(o);if(!a[e]||"item"!==a[e].type)return;a.splice(i,0,a.splice(e,1)[0]);let r=_GROUP_DEFS[0];const n=[];for(const t of a)"divider"!==t.type?n.push({...t.item,vertical:r.vertical,horizontal:r.horizontal}):r=t.group;this._config={...this._config,items:n},this._fireConfig()}_verticalOptions=VERTICAL_OPTIONS;_horizontalOptions=HORIZONTAL_OPTIONS;_imageSourceTypeOptions=IMAGE_SOURCE_TYPE_OPTIONS;_cameraViewOptions=CAMERA_VIEW_OPTIONS;_fitModeOptions=FIT_MODE_OPTIONS;_objectPositionOptions=OBJECT_POSITION_OPTIONS;_renderItemsPanel(){const t=this._config?.items??[],e=this._buildRows(t);return html`
        ...
        <ha-sortable handle-selector=".handle" @item-moved=${t=>this._itemMoved(t)}>
          <div class="items-list">
            ${repeat(e,t=>t.key,t=>{if("divider"===t.type)return html`
                ...
                `;const e=t.item,i=t.itemIndex,o="entity"in e,a=o?"Entity":"Template",r=o?"entity":"template",n=o?e.entity||`Entity ${i+1}`:e.template?e.template.length>30?e.template.slice(0,30)+"…":e.template:`Template ${i+1}`,s=serializeExtrasToYaml(e,UI_ITEM_KEYS);return html`
                <ha-expansion-panel
                  outlined
                  data-item-id="${e._id}"
  ...
  `;render(){if(!this._config)return html``;const t=this._config,e=serializeExtrasToYaml(t,UI_CARD_KEYS),i=t.image_source_type??"camera",o="fill"!==(t.fit_mode??"fill");return html`
    ...
    `}}customElements.define("chrono-picture-card-editor",ChronoPictureCardEditor);class ChronoPictureCard extends LitElement{static properties={_config:{attribute:!1},_itemValues:{state:!0},_popup:{state:!0},_measuredAspectRatio:{state:!0}};static getCardSize(){return 3}static getConfigElement(){return document.createElement("chrono-picture-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG,image:"https://demo.home-assistant.io/stub_config/kitchen.png",items:[{template:"My Camera",horizontal:"left",vertical:"bottom",font_color:"white",font_size:1.1,font_weight:600}]}}constructor(){super(),this._config=null,this._hass=null,this._itemValues={},this._templateUnsubs=[],this._subscribed=!1,this._popup=null,this._measuredAspectRatio=null,this._aspectSourceKey=null,this._aspectListenerAttached=!1}set hass(t){const e=this._hass,i=e?.connection;this._hass=t,this._config&&(t.connection===i&&this._subscribed||this._setupSubscriptions()),this._hassShouldRender(e,t)&&this.requestUpdate()}get hass(){return this._hass}_hassShouldRender(t,e){if(!t||!e)return!0;const i=this._config;if(!i)return!0;if("camera"===(i.image_source_type??(i.camera_image?"camera":i.image_entity?"entity":"url"))&&i.camera_image)return!0;if(t.locale!==e.locale||t.formatEntityState!==e.formatEntityState)return!0;const o=new Set;i.image_entity&&o.add(i.image_entity);for(const t of i.items??[])t.entity&&o.add(t.entity);for(const i of o)if(t.states?.[i]!==e.states?.[i])return!0;return!1}setConfig(t){({config:t}=migrateConfig(t));let e=!this._subscribed;if(!e&&this._config){const i=this._config.items??[],o=t.items??[];for(let t=0;t<Math.max(i.length,o.length);t++){const a=i[t]?.template??"",r=o[t]?.template??"";if(r!==a&&(a.includes("{{")||r.includes("{{"))){e=!0;break}}}this._config=t,this._hass&&e&&this._setupSubscriptions();const i=t.image_source_type??(t.camera_image?"camera":t.image_entity?"entity":"url"),o=JSON.stringify({sourceType:i,camera_image:t.camera_image,camera_view:t.camera_view,image:t.image,image_entity:t.image_entity});o!==this._aspectSourceKey&&(this._aspectSourceKey=o,this._measuredAspectRatio=null,this._aspectListenerAttached=!1)}connectedCallback(){super.connectedCallback(),this._hass&&this._config&&!this._subscribed&&this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}_setupSubscriptions(){this._teardownSubscriptions(),this._itemValues={};const t=(t,e)=>{const i=String(t);if(!i.includes("{{"))return void e(i);const o=this._hass.connection.subscribeMessage(t=>e(t.result),{type:"render_template",template:i});this._templateUnsubs.push(o)};(this._config?.items??[]).forEach((e,i)=>{if("template"in e){const o=`item-${i}`;t(e.template??"",t=>{this._itemValues={...this._itemValues,[o]:t}})}}),this._subscribed=!0}_teardownSubscriptions(){this._templateUnsubs.forEach(t=>{Promise.resolve(t).then(t=>{"function"==typeof t&&t()}).catch(()=>{})}),this._templateUnsubs=[],this._subscribed=!1}_findMediaElement(t){if(!t)return null;const e=t.querySelector("video, img, canvas");if(e)return e;const i=t.querySelectorAll("*");for(const t of i)if(t.shadowRoot){const e=this._findMediaElement(t.shadowRoot);if(e)return e}return null}_applyMeasuredRatio(t,e){if(!t||!e)return;const i=`${t} / ${e}`;i!==this._measuredAspectRatio&&(this._measuredAspectRatio=i)}_measureAspectRatioFromMedia(){if(this._config?.aspect_ratio)return;if(this._measuredAspectRatio)return;if(this._aspectListenerAttached)return;const t=this._findMediaElement(this.shadowRoot);if(!t)return;const e=t.tagName.toLowerCase();if("video"===e&&t.videoWidth&&t.videoHeight)return void this._applyMeasuredRatio(t.videoWidth,t.videoHeight);if("img"===e&&t.naturalWidth&&t.naturalHeight)return void this._applyMeasuredRatio(t.naturalWidth,t.naturalHeight);if("canvas"===e&&t.width&&t.height)return void this._applyMeasuredRatio(t.width,t.height);this._aspectListenerAttached=!0;const i="video"===e?"loadedmetadata":"load";t.addEventListener(i,()=>{"video"===e?this._applyMeasuredRatio(t.videoWidth,t.videoHeight):"img"===e?this._applyMeasuredRatio(t.naturalWidth,t.naturalHeight):"canvas"===e&&this._applyMeasuredRatio(t.width,t.height)},{once:!0})}updated(t){super.updated?.(t),this._measureAspectRatioFromMedia(),this._config?.aspect_ratio?this.style.removeProperty("--chrono-fallback-ratio"):this._measuredAspectRatio&&this.style.setProperty("--chrono-fallback-ratio",this._measuredAspectRatio)}_handleAction(t,e="tap"){if(!this._hass)return;const i="double_tap"===e&&t.double_tap_action?t.double_tap_action:"hold"===e&&t.hold_action?t.hold_action:t.tap_action;if("input-select-popup"!==i?.action){if("tap"===e&&!t.tap_action&&t.entity){const i=t.entity.split(".")[0];if("light"===i)return void handleAction(this,this._hass,{...t,tap_action:{action:"toggle"}},e);if("button"===i)return void handleAction(this,this._hass,{...t,tap_action:{action:"perform-action",perform_action:"button.press"}},e)}handleAction(this,this._hass,t,e)}else this._openPopup(i)}_openPopup(t){const e=t.entity;if(!e)return;const i=this._hass.states[e];i&&(this._popup={entity:e,options:i.attributes.options??[],current:i.state,on_select:t.on_select??null})}_selectPopupOption(t){const e=this._popup;this._popup=null,e&&this._hass&&(this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t}),e.on_select&&handleAction(this,this._hass,{tap_action:e.on_select,entity:e.entity},"tap"))}_itemStyleMap(t){const e=t=>""!==t&&null!=t?`${t}px`:void 0,i=t=>""!==t&&null!=t?`${t}`:void 0;return{color:t.font_color||void 0,"font-size":(o=t.font_size,""!==o&&null!=o?`${o}em`:void 0),"font-weight":i(t.font_weight),"line-height":i(t.line_height),"border-radius":e(t.border_radius),"background-color":t.background_color||void 0,"padding-top":e(t.padding_top),"padding-bottom":e(t.padding_bottom),"padding-left":e(t.padding_left),"padding-right":e(t.padding_right)};var o}_renderItem(t,e){if(!1===t.show)return html``;if("template"in t){const i=`item-${e}`,o=this._itemValues[i]??"",a=t.tap_action&&"none"!==t.tap_action.action;return html`
        <span
