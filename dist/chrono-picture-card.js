import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import{repeat}from"https://unpkg.com/lit@2.0.0/directives/repeat.js?module";import jsyaml from"https://cdn.jsdelivr.net/npm/js-yaml@4/+esm";const CARD_VERSION="0.4.46",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cPICTURE%c-CARD %c v0.4.46 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DOMAINS_TOGGLE=new Set(["automation","cover","fan","group","humidifier","input_boolean","light","media_player","remote","script","switch","timer","vacuum"]),ACTIVE_STATES=["on","open","opening","unlocked","active","home","playing"],DEFAULT_ENTITY_ICON="mdi:circle",DOMAIN_ICON_MAP={light:"mdi:lightbulb",switch:"mdi:toggle-switch",sensor:"mdi:eye",script:"mdi:script-text",automation:"mdi:robot",input_boolean:"mdi:toggle-switch",cover:"mdi:window-shutter",fan:"mdi:fan",media_player:"mdi:cast",camera:"mdi:camera"},DEFAULT_ITEM={_id:"",show:!0,horizontal:"center",vertical:"bottom",icon:"",show_state:!1,font_color:"",font_size:1.2,font_weight:600,line_height:1.2,border_radius:50,background_color:"",padding_top:10,padding_bottom:10,padding_left:10,padding_right:10},DEFAULT_ENTITY_ITEM={...DEFAULT_ITEM,entity:""},DEFAULT_TEMPLATE_ITEM={...DEFAULT_ITEM,template:""},DEFAULT_CONFIG={image_source_type:"camera",entity:"",camera_image:"",camera_view:"live",image:"",image_entity:"",aspect_ratio:"",fit_mode:"fill",object_position:"center",bottom_bar_background_color:"#0000004D",top_bar_background_color:"",items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),UI_ITEM_KEYS=new Set(["_id","show","entity","template","horizontal","vertical","icon","show_state","font_color","font_size","font_weight","line_height","border_radius","background_color","padding_top","padding_bottom","padding_left","padding_right"]),UI_CARD_KEYS=new Set(["type","image_source_type","entity","camera_image","camera_view","image","image_entity","aspect_ratio","fit_mode","object_position","bottom_bar_background_color","top_bar_background_color","items"]),VERTICAL_OPTIONS=[{label:"Top",value:"top"},{label:"Bottom",value:"bottom"}],HORIZONTAL_OPTIONS=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"}],IMAGE_SOURCE_TYPE_OPTIONS=[{label:"Camera",value:"camera"},{label:"Image URL",value:"url"},{label:"Image entity",value:"entity"}],CAMERA_VIEW_OPTIONS=[{label:"Auto",value:"auto"},{label:"Live",value:"live"}],FIT_MODE_OPTIONS=[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"},{label:"Fill",value:"fill"}],OBJECT_POSITION_OPTIONS=[{label:"Center",value:"center"},{label:"Top",value:"top"},{label:"Bottom",value:"bottom"},{label:"Left",value:"left"},{label:"Right",value:"right"}],SHOW_ITEM_POSITION_BADGES=!1,VERTICAL_BADGE_COLORS={top:"#ac00ac",bottom:"#0600ff"},HORIZONTAL_BADGE_COLORS={left:"#bb9e00",center:"#10a800",right:"#00a896"},GROUP_DIVIDER_COLOR="#009ac7",_GROUP_ORDER=["top-left","top-center","top-right","bottom-left","bottom-center","bottom-right"];function sortItems(t){const e=t=>`${t.vertical??"bottom"}-${t.horizontal??"center"}`;return[...t].sort((t,i)=>_GROUP_ORDER.indexOf(e(t))-_GROUP_ORDER.indexOf(e(i)))}function generateId(t=[]){const e=new Set(t.map(t=>t._id));let i;do{i=Math.random().toString(16).slice(2,10)}while(e.has(i));return i}function serializeExtrasToYaml(t,e){const i={};for(const[o,r]of Object.entries(t))e.has(o)||(i[o]=r);if(!Object.keys(i).length)return"";try{return jsyaml.dump(i,{indent:2}).trimEnd()}catch(t){return""}}function parseYamlExtras(t){const e=(t??"").trim();if(!e)return{};try{const t=jsyaml.load(e);return t&&"object"==typeof t&&!Array.isArray(t)?t:null}catch(t){return null}}function getDomain(t){return t?.split(".")?.[0]??""}function defaultTapAction(t){return DOMAINS_TOGGLE.has(t)?{action:"toggle"}:{action:"more-info"}}function isStateActive(t){if(!t)return!1;const e=t.state;return ACTIVE_STATES.includes(e)}const DOMAIN_ICON_MAP_EXTENDED={...DOMAIN_ICON_MAP,binary_sensor:"mdi:radiobox-blank"};function domainIcon(t,e){const i=e?.attributes?.device_class,o="binary_sensor"===t&&i?`mdi:${i}`:DOMAIN_ICON_MAP_EXTENDED[t];return e?.attributes?.icon??o??"mdi:circle"}function parseAspectRatio(t){if(!t)return null;const e=String(t).match(/^(\d+(?:\.\d+)?)\s*[x:\/]\s*(\d+(?:\.\d+)?)$/i);if(e)return(parseFloat(e[1])/parseFloat(e[2])*100).toFixed(4)+"%";const i=parseFloat(t);return isNaN(i)?null:(100*i).toFixed(4)+"%"}function cpParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)?null:i}function cpTextField(t,e,i,o={}){return html`
  ...
  `;constructor(){super(),this.value="",this.options=[],this._open=!1,this._cursor=-1,this._onOutsideClick=this._onOutsideClick.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOutsideClick)}_onOutsideClick(t){this.shadowRoot.contains(t.composedPath()[0])||t.composedPath()[0]===this||(this._open=!1,this._cursor=-1)}_select(t){this.value=t,this._open=!1,this._cursor=-1,this.dispatchEvent(new CustomEvent("change",{detail:{value:t},bubbles:!0,composed:!0}))}_handleKeyDown(t){const e=this.options??[];this._open?"ArrowDown"===t.key?(this._cursor=Math.min(this._cursor+1,e.length-1),t.preventDefault()):"ArrowUp"===t.key?(this._cursor=Math.max(this._cursor-1,0),t.preventDefault()):"Enter"===t.key?(this._cursor>=0&&this._cursor<e.length&&this._select(e[this._cursor].value),t.preventDefault()):"Escape"===t.key&&(this._open=!1,this._cursor=-1,t.preventDefault()):"ArrowDown"!==t.key&&"ArrowUp"!==t.key||(this._open=!0,this._cursor=0,t.preventDefault())}render(){const t=this.options??[];return html`
      ...
      `:""}
    `}}customElements.define("chrono-cp-select",CpSelect);class ChronoPictureCardEditor extends LitElement{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){let e=!1;if(t.left_items||t.center_items||t.right_items){const i=sortItems([...(t.left_items??[]).map(t=>({...t,horizontal:"left"})),...(t.center_items??[]).map(t=>({...t,horizontal:"center"})),...(t.right_items??[]).map(t=>({...t,horizontal:"right"}))]),{left_items:o,center_items:r,right_items:n,...a}=t;t={...a,items:i},e=!0}if(t.items?.some(t=>!t._id)){const i=[];for(const e of t.items)i.push(e._id?e:{...e,_id:generateId(t.items.concat(i))});t={...t,items:i},e=!0}this._config=t,e&&this._fireConfig()}_fireConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_valueChanged(t,e){if(!this._config)return;const i=e.target.value??e.detail?.value;this._config={...this._config,[t]:i},this._fireConfig()}_cardYamlChanged(t){if(!this._config)return;const e=parseYamlExtras(t.target.value??t.detail?.value??"");if(null===e)return;const i={};for(const[t,e]of Object.entries(this._config))UI_CARD_KEYS.has(t)&&(i[t]=e);this._config={...i,...e},this._fireConfig()}_itemChanged(t,e,i){if(!this._config)return;const o=i.target.value??i.detail?.value;let r;if(NUMERIC_ITEM_KEYS.has(e)){const t=cpParseNumber(o);if(null===t)return;r=t}else r=o;let n=[...this._config.items??[]];n[t]={...n[t],[e]:r},"horizontal"!==e&&"vertical"!==e||(n=sortItems(n)),this._config={...this._config,items:n},this._fireConfig()}_itemYamlChanged(t,e){if(!this._config)return;const i=parseYamlExtras(e.target.value??e.detail?.value??"");if(null===i)return;const o=[...this._config.items??[]],r=o[t],n={};for(const[t,e]of Object.entries(r))UI_ITEM_KEYS.has(t)&&(n[t]=e);o[t]={...n,...i},this._config={...this._config,items:o},this._fireConfig()}_itemToggled(t,e,i){if(!this._config)return;const o=i.target.checked,r=[...this._config.items??[]];r[t]={...r[t],[e]:o},this._config={...this._config,items:r},this._fireConfig()}_addItem(t){const e=this._config.items??[],i="entity"===t?{...DEFAULT_ENTITY_ITEM,_id:generateId(e)}:{...DEFAULT_TEMPLATE_ITEM,_id:generateId(e)},o=sortItems([...e,i]);this._config={...this._config,items:o},this._fireConfig()}_removeItem(t){const e=(this._config.items??[]).filter((e,i)=>i!==t);this._config={...this._config,items:e},this._fireConfig()}_itemMoved(t){t.stopPropagation();const{oldIndex:e,newIndex:i}=t.detail,o=[...this._config.items??[]];o.splice(i,0,o.splice(e,1)[0]),this._config={...this._config,items:sortItems(o)},this._fireConfig()}_verticalOptions=VERTICAL_OPTIONS;_horizontalOptions=HORIZONTAL_OPTIONS;_imageSourceTypeOptions=IMAGE_SOURCE_TYPE_OPTIONS;_cameraViewOptions=CAMERA_VIEW_OPTIONS;_fitModeOptions=FIT_MODE_OPTIONS;_objectPositionOptions=OBJECT_POSITION_OPTIONS;_renderItemsPanel(){const t=this._config?.items??[],e=t=>`${"top"===(t.vertical??"bottom")?"Top":"Bottom"} · ${{left:"Left",center:"Center",right:"Right"}[t.horizontal??"center"]}`;return html`
            ...
            ${repeat(t,t=>t._id,(i,o)=>{const r="entity"in i,n=r?"Entity":"Template",a=r?"entity":"template",s=r?i.entity||`Entity ${o+1}`:i.template?i.template.length>35?i.template.slice(0,35)+"…":i.template:`Template ${o+1}`,l=serializeExtrasToYaml(i,UI_ITEM_KEYS),c=t[o-1],p=0===o||e(i)!==e(c);return html`
                ${p?html`
                  <div class="group-divider">
                    <span class="group-divider-label" style="color:${"#009ac7"}">${e(i)}</span>
                ...
                <ha-expansion-panel outlined>
                  ...
                  <div slot="header" class="item-header-slot">
                    <div class="item-header-content${!1===i.show?" item-hidden":""}">
                      ${""}
                    ...
                    <button
                      ...
                      title="${!1===i.show?"Show item":"Hide item"}"
                      @click=${t=>{t.stopPropagation(),this._itemToggled(o,"show",{target:{checked:!1===i.show}})}}
                    >
                      <ha-icon .icon=${!1===i.show?"mdi:eye-off-outline":"mdi:eye-outline"}></ha-icon>
                    </button>
                  </div>
  ...
  `;render(){if(!this._config)return html``;const t=this._config,e=serializeExtrasToYaml(t,UI_CARD_KEYS),i=t.image_source_type??"camera",o="fill"!==(t.fit_mode??"fill");return html`
    ...
    `}}customElements.define("chrono-picture-card-editor",ChronoPictureCardEditor);class ChronoPictureCard extends LitElement{static properties={_config:{attribute:!1},_itemValues:{state:!0},_popup:{state:!0}};static getCardSize(){return 3}static getConfigElement(){return document.createElement("chrono-picture-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG,image:"https://demo.home-assistant.io/stub_config/kitchen.png",items:[{template:"My Camera",horizontal:"left",vertical:"bottom",font_color:"white",font_size:1.1,font_weight:600}]}}constructor(){super(),this._config=null,this._hass=null,this._itemValues={},this._templateUnsubs=[],this._subscribed=!1,this._popup=null}set hass(t){const e=this._hass?.connection;this._hass=t,this._config&&(t.connection===e&&this._subscribed||this._setupSubscriptions()),this.requestUpdate()}get hass(){return this._hass}setConfig(t){if(t.left_items||t.center_items||t.right_items){const e=sortItems([...(t.left_items??[]).map(t=>({...t,horizontal:"left"})),...(t.center_items??[]).map(t=>({...t,horizontal:"center"})),...(t.right_items??[]).map(t=>({...t,horizontal:"right"}))]),{left_items:i,center_items:o,right_items:r,...n}=t;t={...n,items:e}}if(t.items?.some(t=>!t._id)){const e=[];for(const i of t.items)e.push(i._id?i:{...i,_id:generateId(t.items.concat(e))});t={...t,items:e}}let e=!this._subscribed;if(!e&&this._config){const i=this._config.items??[],o=t.items??[];for(let t=0;t<Math.max(i.length,o.length);t++){const r=i[t]?.template??"",n=o[t]?.template??"";if(n!==r&&(r.includes("{{")||n.includes("{{"))){e=!0;break}}}this._config=t,this._hass&&e&&this._setupSubscriptions()}connectedCallback(){super.connectedCallback(),this._hass&&this._config&&!this._subscribed&&this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}_setupSubscriptions(){this._teardownSubscriptions();const t=(t,e)=>{const i=String(t);if(!i.includes("{{"))return void e(i);const o=this._hass.connection.subscribeMessage(t=>e(t.result),{type:"render_template",template:i});this._templateUnsubs.push(o)};(this._config?.items??[]).forEach((e,i)=>{if("template"in e){const o=`item-${i}`;t(e.template??"",t=>{this._itemValues={...this._itemValues,[o]:t}})}}),this._subscribed=!0}_teardownSubscriptions(){this._templateUnsubs.forEach(t=>{Promise.resolve(t).then(t=>{"function"==typeof t&&t()}).catch(()=>{})}),this._templateUnsubs=[],this._subscribed=!1}_fireAction(t,e){if(e?.action&&"none"!==e.action)switch(e.action){case"toggle":t&&this._hass.callService("homeassistant","toggle",{entity_id:t});break;case"more-info":this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t||this._config.entity},bubbles:!0,composed:!0}));break;case"navigate":history.pushState(null,"",e.navigation_path),this.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0}));break;case"call-service":{const[t,i]=(e.service||"").split(".");t&&i&&this._resolveDataTemplates(e.data||{}).then(e=>{this._hass.callService(t,i,e)});break}case"url":e.url_path&&window.open(e.url_path,"_blank");break;case"input-select-popup":{const t=e.entity;if(!t)break;const i=this._hass.states[t];if(!i)break;this._popup={entity:t,options:i.attributes.options??[],current:i.state,on_select:e.on_select??null};break}}}async _resolveDataTemplates(t){const e=Object.entries(t),i=e.filter(([,t])=>"string"==typeof t&&t.includes("{{"));if(!i.length)return t;const o={};for(const[t,i]of e)"string"==typeof i&&i.includes("{{")||(o[t]=i);return await Promise.all(i.map(([t,e])=>new Promise(i=>{const r=this._hass.connection.subscribeMessage(e=>{o[t]=e.result,r.then(t=>t()),i()},{type:"render_template",template:e})}))),o}async _selectPopupOption(t){const e=this._popup;if(this._popup=null,!e.on_select)return void this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t});const i={...e.on_select};i.data?(this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t}),i.data=await this._resolveDataTemplates(i.data)):this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t}),this._hass&&this._fireAction(null,i)}_itemStyleMap(t){return{color:t.font_color||void 0,"font-size":""!==t.font_size&&null!=t.font_size?`${t.font_size}em`:void 0,"font-weight":""!==t.font_weight&&null!=t.font_weight?`${t.font_weight}`:void 0,"line-height":""!==t.line_height&&null!=t.line_height?`${t.line_height}`:void 0,"border-radius":""!==t.border_radius&&null!=t.border_radius?`${t.border_radius}px`:void 0,"background-color":t.background_color||void 0,"padding-top":""!==t.padding_top&&null!=t.padding_top?`${t.padding_top}px`:void 0,"padding-bottom":""!==t.padding_bottom&&null!=t.padding_bottom?`${t.padding_bottom}px`:void 0,"padding-left":""!==t.padding_left&&null!=t.padding_left?`${t.padding_left}px`:void 0,"padding-right":""!==t.padding_right&&null!=t.padding_right?`${t.padding_right}px`:void 0}}_renderItem(t,e){if(!1===t.show)return html``;if("template"in t){const i=`item-${e}`,o=this._itemValues[i]??"",r=t.tap_action&&"none"!==t.tap_action.action;return html`
        <span
      ...
      `}return html``}_renderZone(t,e){const i=this._config?.items??[],o=new Map(i.map((t,e)=>[t,e])),r=i.filter(i=>(i.horizontal??"center")===t&&(i.vertical??"bottom")===e);return html`
      <div class="bar-zone bar-zone-${t}">
        ${r.map(t=>this._renderItem(t,o.get(t)))}
      </div>
    `}static styles=css`
    :host {
      display: block;
  ...
  `;render(){if(!this._config||!this._hass)return html``;const t=this._config,e=parseAspectRatio(t.aspect_ratio),i=t.fit_mode||"fill",o=t.object_position||"center",r="camera"===(t.image_source_type??(t.camera_image?"camera":t.image_entity?"entity":"url"))&&!!t.camera_image;let n=t.image||"";if(t.image_entity){const e=this._hass.states[t.image_entity],i=getDomain(t.image_entity);"image"===i&&e?n=`/api/image_proxy/${t.image_entity}?token=${e.attributes.access_token}&time=${e.last_updated}`:"person"===i&&e?.attributes?.entity_picture&&(n=e.attributes.entity_picture)}const a={"object-fit":i,"object-position":o},s=["image-container",!r&&e?"has-ratio":"",t.tap_action?.action&&"none"!==t.tap_action.action?"clickable":""].filter(Boolean).join(" ");return html`
      <ha-card>
        <div
          class="${s}"
          style="${!r&&e?`padding-bottom: ${e};`:""}"
