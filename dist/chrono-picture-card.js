import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import jsyaml from"https://cdn.jsdelivr.net/npm/js-yaml@4/+esm";const CARD_VERSION="0.2.32",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cPICTURE%c-CARD %c v0.2.32 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DOMAINS_TOGGLE=new Set(["automation","cover","fan","group","humidifier","input_boolean","light","media_player","remote","script","switch","timer","vacuum"]),ZONE_KEYS=["left","center","right"],ACTIVE_STATES=["on","open","opening","unlocked","active","home","playing"],DEFAULT_ENTITY_ICON="mdi:circle",DOMAIN_ICON_MAP={light:"mdi:lightbulb",switch:"mdi:toggle-switch",sensor:"mdi:eye",script:"mdi:script-text",automation:"mdi:robot",input_boolean:"mdi:toggle-switch",cover:"mdi:window-shutter",fan:"mdi:fan",media_player:"mdi:cast",camera:"mdi:camera"},DEFAULT_ITEM={vertical:"bottom",icon:"",show_state:!1,font_color:"",font_size:"",font_weight:"",line_height:"",border_radius:"",background_color:"",padding_top:"",padding_bottom:"",padding_left:"",padding_right:""},DEFAULT_ENTITY_ITEM={...DEFAULT_ITEM,entity:""},DEFAULT_TEMPLATE_ITEM={...DEFAULT_ITEM,template:""},DEFAULT_CONFIG={image_source_type:"camera",entity:"",camera_image:"",camera_view:"live",image:"",image_entity:"",aspect_ratio:"",fit_mode:"fill",object_position:"center",bottom_bar_background_color:"#0000004D",top_bar_background_color:"",left_items:[],center_items:[],right_items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),UI_ITEM_KEYS=new Set(["entity","template","vertical","icon","show_state","font_color","font_size","font_weight","line_height","border_radius","background_color","padding_top","padding_bottom","padding_left","padding_right"]),UI_CARD_KEYS=new Set(["type","image_source_type","entity","camera_image","camera_view","image","image_entity","aspect_ratio","fit_mode","object_position","bottom_bar_background_color","top_bar_background_color","left_items","center_items","right_items"]),VERTICAL_OPTIONS=[{label:"Bottom",value:"bottom"},{label:"Top",value:"top"}],IMAGE_SOURCE_TYPE_OPTIONS=[{label:"Camera",value:"camera"},{label:"Image URL",value:"url"},{label:"Image entity",value:"entity"}],CAMERA_VIEW_OPTIONS=[{label:"Auto",value:"auto"},{label:"Live",value:"live"}],FIT_MODE_OPTIONS=[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"},{label:"Fill",value:"fill"}],OBJECT_POSITION_OPTIONS=[{label:"Center",value:"center"},{label:"Top",value:"top"},{label:"Bottom",value:"bottom"},{label:"Left",value:"left"},{label:"Right",value:"right"}];function serializeExtrasToYaml(t,e){const i={};for(const[o,n]of Object.entries(t))e.has(o)||(i[o]=n);if(!Object.keys(i).length)return"";try{return jsyaml.dump(i,{indent:2}).trimEnd()}catch(t){return""}}function parseYamlExtras(t){const e=(t??"").trim();if(!e)return{};try{const t=jsyaml.load(e);return t&&"object"==typeof t&&!Array.isArray(t)?t:null}catch(t){return null}}function getDomain(t){return t?.split(".")?.[0]??""}function defaultTapAction(t){return DOMAINS_TOGGLE.has(t)?{action:"toggle"}:{action:"more-info"}}function isStateActive(t){if(!t)return!1;const e=t.state;return ACTIVE_STATES.includes(e)}function domainIcon(t,e){const i=e?.attributes?.device_class,o={...DOMAIN_ICON_MAP,binary_sensor:i?`mdi:${i}`:"mdi:radiobox-blank"};return e?.attributes?.icon??o[t]??"mdi:circle"}function parseAspectRatio(t){if(!t)return null;const e=String(t).match(/^(\d+(?:\.\d+)?)\s*[x:\/]\s*(\d+(?:\.\d+)?)$/i);if(e)return(parseFloat(e[1])/parseFloat(e[2])*100).toFixed(4)+"%";const i=parseFloat(t);return isNaN(i)?null:(100*i).toFixed(4)+"%"}function cpParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(e.includes(".")&&e.endsWith("0"))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)?null:i}function cpTextField(t,e,i,o={}){return html`
            ...
            ${e.map((e,i)=>{const o="entity"in e,n=o?"Entity":"Template",a=o?"entity":"template",r=o?e.entity||`Entity ${i+1}`:e.template?e.template.length>35?e.template.slice(0,35)+"…":e.template:`Template ${i+1}`,s=serializeExtrasToYaml(e,UI_ITEM_KEYS);return html`
                <ha-expansion-panel outlined>
                  ...
                  <div class="item-position-row">
                    ${cpButtonPicker("",e.vertical??"bottom",this._verticalOptions,e=>this._itemChanged(t,i,"vertical",e))}
                  </div>
  ...
  `;render(){if(!this._config)return html``;const t=this._config,e=serializeExtrasToYaml(t,UI_CARD_KEYS),i=t.image_source_type??"camera",o="fill"!==(t.fit_mode??"fill");return html`
    ...
    `}}customElements.define("chrono-picture-card-editor",ChronoPictureCardEditor);class ChronoPictureCard extends LitElement{static properties={_config:{attribute:!1},_itemValues:{state:!0},_popup:{state:!0}};static getCardSize(){return 3}static getConfigElement(){return document.createElement("chrono-picture-card-editor")}static getStubConfig(){return{...DEFAULT_CONFIG,image:"https://demo.home-assistant.io/stub_config/kitchen.png",left_items:[{template:"My Camera",font_color:"white",font_size:1.1,font_weight:600}],center_items:[],right_items:[]}}constructor(){super(),this._config=null,this._hass=null,this._itemValues={},this._templateUnsubs=[],this._popup=null}set hass(t){const e=this._hass?.connection;this._hass=t,this._config&&(t.connection===e&&0!==this._templateUnsubs.length||this._setupSubscriptions()),this.requestUpdate()}get hass(){return this._hass}setConfig(t){let e=0===this._templateUnsubs.length;if(!e&&this._config)t:for(const i of ZONE_KEYS){const o=this._config[`${i}_items`]??[],n=t[`${i}_items`]??[];for(let t=0;t<Math.max(o.length,n.length);t++){const i=o[t]?.template??"",a=n[t]?.template??"";if(a!==i&&(i.includes("{{")||a.includes("{{"))){e=!0;break t}}}this._config=t,this._hass&&e&&this._setupSubscriptions()}connectedCallback(){super.connectedCallback(),this._hass&&this._config&&0===this._templateUnsubs.length&&this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}_setupSubscriptions(){this._teardownSubscriptions();const t=(t,e)=>{const i=String(t);if(!i.includes("{{"))return void e(i);const o=this._hass.connection.subscribeMessage(t=>e(t.result),{type:"render_template",template:i});this._templateUnsubs.push(o)};for(const e of ZONE_KEYS){(this._config?.[`${e}_items`]??[]).forEach((i,o)=>{if("template"in i){const n=`${e}-${o}`;t(i.template??"",t=>{this._itemValues={...this._itemValues,[n]:t}})}})}}_teardownSubscriptions(){this._templateUnsubs.forEach(t=>{if("function"==typeof t)try{const e=t();e&&"function"==typeof e.catch&&e.catch(()=>{})}catch(t){}}),this._templateUnsubs=[]}_fireAction(t,e){if(e?.action&&"none"!==e.action)switch(e.action){case"toggle":t&&this._hass.callService("homeassistant","toggle",{entity_id:t});break;case"more-info":this.dispatchEvent(new CustomEvent("hass-more-info",{detail:{entityId:t||this._config.entity},bubbles:!0,composed:!0}));break;case"navigate":history.pushState(null,"",e.navigation_path),this.dispatchEvent(new CustomEvent("location-changed",{bubbles:!0,composed:!0}));break;case"call-service":{const[t,i]=(e.service||"").split(".");if(t&&i){const o=this._resolveDataTemplates(e.data||{});this._hass.callService(t,i,o)}break}case"url":e.url_path&&window.open(e.url_path,"_blank");break;case"input-select-popup":{const t=e.entity;if(!t)break;const i=this._hass.states[t];if(!i)break;this._popup={entity:t,options:i.attributes.options??[],current:i.state,on_select:e.on_select??null};break}}}_resolveDataTemplates(t){const e={};for(const[i,o]of Object.entries(t))"string"==typeof o&&o.includes("{{")?e[i]=o.replace(/\{\{\s*states\(\s*['"](.*?)['"]\s*\)\s*\}\}/g,(t,e)=>this._hass.states[e]?.state??""):e[i]=o;return e}async _selectPopupOption(t){const e=this._popup;if(this._popup=null,!e.on_select)return void this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t});const i={...e.on_select};if(i.data){this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t});const o={},n=Object.entries(i.data).filter(([,t])=>"string"==typeof t&&t.includes("{{")),a=Object.entries(i.data).filter(([,t])=>!("string"==typeof t&&t.includes("{{")));for(const[t,e]of a)o[t]=e;await Promise.all(n.map(([t,e])=>new Promise(i=>{const n=this._hass.connection.subscribeMessage(e=>{o[t]=e.result,n.then(t=>t()),i()},{type:"render_template",template:e})}))),i.data=o}else this._hass.callService("input_select","select_option",{entity_id:e.entity,option:t});this._fireAction(null,i)}_itemStyleMap(t){return{color:t.font_color||void 0,"font-size":""!==t.font_size&&null!=t.font_size?`${t.font_size}em`:void 0,"font-weight":""!==t.font_weight&&null!=t.font_weight?`${t.font_weight}`:void 0,"line-height":""!==t.line_height&&null!=t.line_height?`${t.line_height}`:void 0,"border-radius":""!==t.border_radius&&null!=t.border_radius?`${t.border_radius}px`:void 0,"background-color":t.background_color||void 0,"padding-top":""!==t.padding_top&&null!=t.padding_top?`${t.padding_top}px`:void 0,"padding-bottom":""!==t.padding_bottom&&null!=t.padding_bottom?`${t.padding_bottom}px`:void 0,"padding-left":""!==t.padding_left&&null!=t.padding_left?`${t.padding_left}px`:void 0,"padding-right":""!==t.padding_right&&null!=t.padding_right?`${t.padding_right}px`:void 0}}_renderItem(t,e,i){if("template"in t){const o=`${e}-${i}`,n=this._itemValues[o]??"",a=t.tap_action&&"none"!==t.tap_action.action;return html`
      ...
      `}return html``}_renderZone(t,e){const i=(this._config?.[`${t}_items`]??[]).filter(t=>(t.vertical??"bottom")===e);return html`
      <div class="bar-zone bar-zone-${t}">
        ${i.map((e,i)=>this._renderItem(e,t,i))}
      </div>
    `}static styles=css`
    :host {
      display: block;
