import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";const CARD_VERSION="0.0.4",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cPICTURE%c-CARD %c v0.0.4 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DOMAINS_TOGGLE=new Set(["automation","cover","fan","group","humidifier","input_boolean","light","media_player","remote","script","switch","timer","vacuum"]),ZONE_KEYS=["left","center","right"],DEFAULT_ITEM={font_color:"",font_size:"",font_weight:"",line_height:"",border_radius:"",background_color:"",padding_top:"",padding_bottom:"",padding_left:"",padding_right:""},DEFAULT_CONFIG={entity:"",camera_image:"",camera_view:"auto",image:"",image_entity:"",aspect_ratio:"16x9",fit_mode:"cover",object_position:"center",tap_action:{action:"more-info"},hold_action:{action:"none"},double_tap_action:{action:"none"},left_items:[],center_items:[],right_items:[]},NUMERIC_ITEM_KEYS=new Set(["font_size","font_weight","line_height","border_radius","padding_top","padding_bottom","padding_left","padding_right"]);function getDomain(t){return t?.split(".")?.[0]??""}function defaultTapAction(t){return DOMAINS_TOGGLE.has(t)?{action:"toggle"}:{action:"more-info"}}function isStateActive(t){if(!t)return!1;const e=t.state;return["on","open","opening","unlocked","active","home","playing"].includes(e)}function domainIcon(t,e){const i=e?.attributes?.device_class,o={light:"mdi:lightbulb",switch:"mdi:toggle-switch",binary_sensor:i?`mdi:${i}`:"mdi:radiobox-blank",sensor:"mdi:eye",script:"mdi:script-text",automation:"mdi:robot",input_boolean:"mdi:toggle-switch",cover:"mdi:window-shutter",fan:"mdi:fan",media_player:"mdi:cast",camera:"mdi:camera"};return e?.attributes?.icon??o[t]??"mdi:circle"}function parseAspectRatio(t){if(!t)return null;const e=String(t).match(/^(\d+(?:\.\d+)?)\s*[x:\/]\s*(\d+(?:\.\d+)?)$/i);if(e)return(parseFloat(e[1])/parseFloat(e[2])*100).toFixed(4)+"%";const i=parseFloat(t);return isNaN(i)?null:(100*i).toFixed(4)+"%"}function cpParseNumber(t){const e=String(t).replace(",",".");if("-"===e||"-0"===e||e.endsWith("."))return null;if(e.includes(".")&&e.endsWith("0"))return null;if(""===e)return"";const i=parseFloat(e);return isNaN(i)?null:i}function cpTextField(t,e,i,o={}){return html`
  ...
  `;constructor(){super(),this.value="",this.options=[],this._open=!1,this._cursor=-1,this._onOutsideClick=this._onOutsideClick.bind(this)}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this._onOutsideClick)}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("click",this._onOutsideClick)}_onOutsideClick(t){this.shadowRoot.contains(t.composedPath()[0])||t.composedPath()[0]===this||(this._open=!1,this._cursor=-1)}_select(t){this.value=t,this._open=!1,this._cursor=-1,this.dispatchEvent(new CustomEvent("change",{detail:{value:t},bubbles:!0,composed:!0}))}_handleKeyDown(t){const e=this.options??[];this._open?"ArrowDown"===t.key?(this._cursor=Math.min(this._cursor+1,e.length-1),t.preventDefault()):"ArrowUp"===t.key?(this._cursor=Math.max(this._cursor-1,0),t.preventDefault()):"Enter"===t.key?(this._cursor>=0&&this._cursor<e.length&&this._select(e[this._cursor].value),t.preventDefault()):"Escape"===t.key&&(this._open=!1,this._cursor=-1,t.preventDefault()):"ArrowDown"!==t.key&&"ArrowUp"!==t.key||(this._open=!0,this._cursor=0,t.preventDefault())}render(){const t=this.options??[];return html`
      ...
      `:""}
    `}}customElements.define("chrono-cp-select",CpSelect);class ChronoPictureCardEditor extends LitElement{static properties={hass:{attribute:!1},_config:{state:!0}};setConfig(t){this._config=t}_fireConfig(){this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}_valueChanged(t,e){if(!this._config)return;const i=e.target.value??e.detail?.value;this._config={...this._config,[t]:i},this._fireConfig()}_actionChanged(t,e){if(!this._config)return;const i=e.detail?.value??e.target.value;this._config={...this._config,[t]:{...this._config[t],action:i}},this._fireConfig()}_actionNavPathChanged(t,e){if(!this._config)return;const i=e.target.value??e.detail?.value;this._config={...this._config,[t]:{...this._config[t],navigation_path:i}},this._fireConfig()}_itemChanged(t,e,i,o){if(!this._config)return;const n=o.target.value??o.detail?.value;let a;if(NUMERIC_ITEM_KEYS.has(i)){const t=cpParseNumber(n);if(null===t)return;a=t}else a=n;const r=[...this._config[`${t}_items`]??[]];r[e]={...r[e],[i]:a},this._config={...this._config,[`${t}_items`]:r},this._fireConfig()}_itemToggled(t,e,i,o){if(!this._config)return;const n=o.target.checked,a=[...this._config[`${t}_items`]??[]];a[e]={...a[e],[i]:n},this._config={...this._config,[`${t}_items`]:a},this._fireConfig()}_addItem(t,e){const i="entity"===e?{...DEFAULT_ITEM,entity:""}:{...DEFAULT_ITEM,template:""},o=[...this._config[`${t}_items`]??[],i];this._config={...this._config,[`${t}_items`]:o},this._fireConfig()}_removeItem(t,e){const i=(this._config[`${t}_items`]??[]).filter((t,i)=>i!==e);this._config={...this._config,[`${t}_items`]:i},this._fireConfig()}_itemMoved(t,e){e.stopPropagation();const{oldIndex:i,newIndex:o}=e.detail,n=[...this._config[`${t}_items`]??[]];n.splice(o,0,n.splice(i,1)[0]),this._config={...this._config,[`${t}_items`]:n},this._fireConfig()}_cameraViewOptions=[{label:"Auto",value:"auto"},{label:"Live",value:"live"}];_fitModeOptions=[{label:"Cover",value:"cover"},{label:"Contain",value:"contain"},{label:"Fill",value:"fill"}];_objectPositionOptions=[{label:"Center",value:"center"},{label:"Top",value:"top"},{label:"Bottom",value:"bottom"},{label:"Left",value:"left"},{label:"Right",value:"right"}];_actionOptions=[{label:"More info",value:"more-info"},{label:"Toggle",value:"toggle"},{label:"Navigate",value:"navigate"},{label:"Call service",value:"call-service"},{label:"None",value:"none"}];_renderZonePanel(t){const e=this._config?.[`${t}_items`]??[],i=t.charAt(0).toUpperCase()+t.slice(1);return html`
