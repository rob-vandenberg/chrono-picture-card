      ...
      <ha-expansion-panel header="Items configuration" outlined>
        ...
        <ha-sortable handle-selector=".handle" @item-moved=${t=>this._itemMoved(t)}>
          <div class="items-list">
            ${t.map((i,o)=>{const r="entity"in i,n=r?"Entity":"Template",a=r?"entity":"template",s=r?i.entity||`Entity ${o+1}`:i.template?i.template.length>35?i.template.slice(0,35)+"…":i.template:`Template ${o+1}`,l=serializeExtrasToYaml(i,UI_ITEM_KEYS),c=t[o-1],p=0===o||e(i)!==e(c);return html`
                ${p?html`
